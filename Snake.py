...
def init_vars():
	...
	head_pos = [120, 60]
	snake_body = [[120, 60]]
	food_pos = [random.randrange(1, (frame_size_x // square_size) - 1) * square_size, random.randrange(1,
	(frame_size_y // square_size) - 1) * square_size]
	food_spawn = True
	score = 0
